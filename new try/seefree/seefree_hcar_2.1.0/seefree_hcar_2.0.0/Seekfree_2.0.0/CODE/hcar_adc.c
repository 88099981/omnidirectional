...
vuint8 l_loop_delay=0;
vuint8 r_loop_delay=0;
...
//    }
    ...
    if(ad_all>260&&chuhuan_delay<=0&&ruhuan_delay<=0)
    {
        if(zuo_yuanhuan_flag==0&&you_yuanhuan_flag==0)
        {
            ruhuan++;
            judge_lr+=fuhe_ad_all-230;
            if(judge_lr>80)//zuo
            {
                if(ruhuan>=1)
                {
                    ...
                    bb_time=20;
                    ruhuan_wait=120;//等出环
                    ruhuan_delay=30;//防止二次误判
                    judge_lr=0;
                }
            }
            else if(judge_lr<-100)//you
            {
                if(ruhuan>=1)
                {
                    you_yuanhuan_flag=1;
        ...
        else
        {
            ...
            if(zuo_yuanhuan_flag==1&&chuhuan>=10)
            {
                zuo_yuanhuan_flag=0;
                //camera_down=100;
                ad_left=ad_value1*0.5+ad_value2*0.7;
            ...
            else if(you_yuanhuan_flag==1&&chuhuan>=10)
            {
                ...
                ad_right=ad_value3*0.7+ad_value4*0.5;
                chuhuan=0;
                bb_time=60;
                chuhuan_delay=200;
            }
