...
#define MT9V034_VSYNC_PIN       PB4                 //场中断
#define MT9V034_VSYNC_IRQN      EXTI4_IRQn          //中断号
#define MT9V034_DMA_CH          DMA1_Channel4       //DMA通道
#define MT9V034_DMA_IRQN        DMA1_Channel4_IRQn  //DMA中断号
#define MT9V034_PCLK_PIN        A12                 //GPIO触发TIM管脚 TIMER1:PA12;TIMER3:PD2
...
#define MT9V034_SCL_PIN   GPIOB,GPIO_Pin_8   /*!< SCCB SCL 管脚 */
#define MT9V034_SDA_PIN   GPIOB,GPIO_Pin_9   /*!< SCCB SDA 管脚 */

void MT9V034_SCL_Out(void);      //配置输出作为SCL_Out
void MT9V034_SDA_Out(void);      //配置作为输出作为SDA_Out
void MT9V034_SDA_In(void);       //配置作为输入作为SDA_In
/*
#define MT9V034_SCL_Out   PIN_Dir(MT9V034_SCL_PIN);      //配置输出作为SCL_Out
#define MT9V034_SDA_Out   PIN_Dir(MT9V034_SDA_PIN);      //配置作为输出作为SDA_Out
#define MT9V034_SDA_In    PIN_Dir(MT9V034_SDA_PIN);      //配置作为输入作为SDA_In
*/
